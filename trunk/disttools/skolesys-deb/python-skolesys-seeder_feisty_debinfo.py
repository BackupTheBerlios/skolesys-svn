...
copy = {
	...
	'misc/etc/ldap/schema/skolesys.schema': '/usr/share/python-support/python-skolesys-seeder/skolesys/seeder',
	'misc/etc/ldap/schema/samba.schema': '/usr/share/python-support/python-skolesys-seeder/skolesys/seeder'
}
