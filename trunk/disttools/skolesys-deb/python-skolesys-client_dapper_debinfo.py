...
control = {
	...
	'Priority': 'optional',
	'Architecture': 'all',
	'Depends': 'python-support, python-soappy, m2crypto',
	'Recommends': 'skolesys_ui',
	'Maintainer': 'Jakob Simon-Gaarde <jakob@skolesys.dk>',
	'Replaces': 'python2.4-skolesys-seeder, python-skolesys-seeder, python2.4-skolesys-client',
	'Conflicts': 'python2.4-skolesys-mainserver, python2.4-skolesys-seeder, python-skolesys-mainserver, python-skolesys-seeder',
	'Provides': 'python2.3-skolesys-client, python2.4-skolesys-client',
